#!/usr/bin/env python3
"""Extract and format requirements from PDF documents into markdown"""
...
def main():
    ...
    pdf_files = {
        'BRD - Shuttle System': r'c:\Program1\Projects\Shuttle\DokumenKebutuhan\1. BRD - SHUTTLE SYSTEM (BOOKING & TRACKING).pdf',
        'SRS - Shuttle System': r'c:\Program1\Projects\Shuttle\DokumenKebutuhan\2. SRS - SHUTTLE SYSTEM (BOOKING & TRACKING).pdf',
        'TB - Shuttle System': r'c:\Program1\Projects\Shuttle\DokumenKebutuhan\3. TB - SHUTTLE SYSTEM (BOOKING & TRACKING).pdf'
    }
